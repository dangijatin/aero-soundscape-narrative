    ...
    <section id="network" className="scroll-section py-32 bg-gradient-to-b from-audiolights-900 to-audiolights-950 text-white relative overflow-hidden">
      ...
      <div className="container mx-auto relative z-10 py-[60px] px-[59px]">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.8 }}
          className="bg-audiolights-800/30 backdrop-blur-sm p-8 md:p-12 rounded-2xl border border-audiolights-700/30 max-w-7xl mx-auto"
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 xl:gap-12 items-center">
            {/* Left side - Information and Toggle */}
            <div className="space-y-8">
              <div>
                <h3 className="text-2xl md:text-3xl font-bold mb-6 tracking-tight">Pan-India Reach</h3>
                <div className="space-y-4 text-audiolights-200/90">
              ...
              <div className="bg-audiolights-800/50 p-6 rounded-xl border border-audiolights-700/30">
                ...
                <div className="space-y-2 text-audiolights-200/90">
                  <p className="whitespace-pre-line text-sm">
                    {activeLocationData.address}
                  </p>
                  <p className="text-sm">{activeLocationData.phone}</p>
                  <p className="text-sm">{activeLocationData.email}</p>
                </div>
              </div>
            </div>
