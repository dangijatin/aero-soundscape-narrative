...
const HeroSection = () => {
  return <section id="hero" className="relative overflow-hidden bg-black text-white">
      ...
      <LampContainer className="min-h-screen relative z-30 pt-24">
        ...
        ease: [0.25, 0.4, 0.25, 1]
          ...
          <ScrollReveal delay={2}>
            <p className="text-xl md:text-2xl lg:text-3xl text-audiolights-200 max-w-3xl mx-auto my-8 font-light px-0 py-[20px]">
              Designing, Innovating, and Equipping the Future of Sound
            </p>
          </ScrollReveal>
          
          <ScrollReveal delay={3}>
            <div className="flex justify-center mt-10 mx-[124px] my-0 px-0 py-[30px]">
              <AudioVisualizer className="mb-8 scale-125" barCount={9} />
            </div>
          </ScrollReveal>
          
          <ScrollReveal delay={4}>
            <motion.a href="#expertise" whileHover={{
            y: 5
