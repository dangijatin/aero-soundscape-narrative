...
const IntroSection = () => {
  return <section id="intro" className="scroll-section py-32 bg-gradient-to-b from-audiolights-50 to-white relative overflow-hidden">
      {/* Background Patterns */}
      ...
      <div className="container relative z-10 my-0 mx-[12px] py-[11px] px-[60px]">
        <motion.div initial={{
        opacity: 0,
        y: 20
      }} whileInView={{
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-6xl mx-auto">
          <FloatingCard delay={1} direction={-1}>
            <div className="backdrop-blur-sm p-10 shadow-xl hover:shadow-2xl transition-shadow duration-300 text-center border border-audiolights-200/20 px-0 rounded-xl bg-white">
              ...
              <p className="text-audiolights-600/90 leading-relaxed py-[25px] my-0 mx-[28px]">
          ...
          <FloatingCard delay={2}>
            <div className="bg-white/80 backdrop-blur-sm p-10 rounded-xl shadow-xl hover:shadow-2xl transition-shadow duration-300 text-center border border-audiolights-200/20">
              ...
              <p className="text-audiolights-600/90 leading-relaxed text-base font-normal text-center mx-[22px] px-[9px]">
          ...
          <FloatingCard delay={3} direction={1}>
            <div className="bg-white/80 backdrop-blur-sm p-10 rounded-xl shadow-xl hover:shadow-2xl transition-shadow duration-300 text-center border border-audiolights-200/20 mx-0">
              <div className="w-24 h-24 mx-auto bg-gradient-to-br from-audiolights-100 to-white rounded-full flex items-center justify-center mb-8 shadow-inner">
                <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-audiolights-copper">
              ...
              <p className="text-audiolights-600/90 leading-relaxed mx-[20px] my-[34px]">
