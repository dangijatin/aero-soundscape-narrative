...
const FloatingCard = ({
  ...
  return <motion.div className="h-full" initial={{
    opacity: 0,
    y: 30
  }} whileInView={{
    opacity: 1,
    ...
    <motion.div className="h-full" animate={{
      x: [0, direction * 5, 0],
      y: [0, 5, 0]
    }} transition={{
      duration: 6,
...
const IntroSection = () => {
  return <section id="intro" className="scroll-section py-32 bg-gradient-to-b from-audiolights-50 to-white relative overflow-hidden">
    ...
    <div className="container relative z-10 my-0 mx-auto py-[11px] px-[60px]">
      <motion.div initial={{
        opacity: 0,
        y: 20
      }} whileInView={{
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-6xl mx-auto">
        <FloatingCard delay={1} direction={-1}>
          <div className="bg-white p-10 rounded-xl shadow-xl hover:shadow-2xl transition-shadow duration-300 text-center border border-audiolights-200/20 h-full flex flex-col items-center">
